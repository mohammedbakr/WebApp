              ...
              <div class="sub-menu">
                <div class="row">
                  ...
                  <div class="col-md-3">
                    ...
                    <ul class="nav-group">
                      <li><a href="../shop/product-categories-4-column-sidebar.html" class="nav-link">4 Column
                          Sidebar</a></li>
                      <li><a href="../shop/product-categories-5-column-sidebar.html" class="nav-link">5 Column
                          Sidebar</a></li>
                      <li><a href="../shop/product-categories-6-column-full-width.html" class="nav-link">6 Column Full
                          width</a></li>
                      <li><a href="../shop/product-categories-7-column-full-width.html" class="nav-link">7 Column Full
                          width</a></li>
                    </ul>
                  </div>
                  <div class="col-md-3">
                    ...
                    <ul class="nav-group mb-3">
                      <li><a href="../shop/single-product-extended.html" class="nav-link">Single Product Extended</a>
                      </li>
                      <li><a href="../shop/single-product-fullwidth.html" class="nav-link">Single Product Fullwidth</a>
                      </li>
                      <li><a href="../shop/single-product-sidebar.html" class="nav-link">Single Product Sidebar</a></li>
                    </ul>
