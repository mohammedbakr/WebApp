...
<div class="container">
    <div class="row">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" @if(request()->input('tab') == 'Company')@endif><a
        ...
        <div class="tab-content customer-order-list">
            <div role="tabpanel" class="tab-pane @if(request()->input('tab') == 'Individual') @endif"
                id="Individual">
                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading"><i class="fa fa-address-card"></i> Register For Individual</div>
            ...
            <div role="tabpanel" class="tab-pane @if(request()->input('tab') == 'Company') @endif"
                id="Company">
